    ...
    return (<>
        <div className={dark ? "home-dark" : "home"}>
            <div className={dark ? 'header-dark' : 'header'}>
                <h1 className="brand">Coin<i className="fab fa-bitcoin"></i>Search</h1>
                <div className="actions">
                    <form >
                        <input className={dark ? "inputField-dark" : "inputField"} type="text" onChange={handleChange} placeholder={`  Search for a coin  `} />
                    </form>
            ...
            {!isLoaded ? <Spinner className="loading" animation="border" variant="danger" size="lg" /> : <div className="coinsContainer">
